      ...
      <section className="about-mission" id="mission">
        <div className="mission-card glass-card">
          ...
          <p>
            ...
            <br /><br />
            Making BKG International School a preferred choice for parents searching for the
            <strong> best CBSE school near me</strong> and a trusted
...
We are confident that your continued trust and support will help BKG International School, the leading CBSE school in Khargone, scale new heights of excellence in education.
`
            },
            {
              ...
              message: `
BKG International School is a top-rated school in Khargone, committed to providing high-quality education. Our motto is to deliver education in a way that nurtures learning without creating unnecessary pressure on students.
We consistently strive to offer excellent academic standards along with the holistic development of every student—focusing on intellectual, physical, emotional, and moral growth.
`
            },
            {
...
Warm greetings from all of us at BKG International School.
As we begin a new academic session, I extend a heartfelt welcome to all our students, staff, and parents.
